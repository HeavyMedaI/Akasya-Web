...
var Application = function(e){
    ...
    this.shape = function (o,d) {
        ...
        $(this.element).mouseover(function(){
            ...
            $(this).find("img.referanslar-bant-img").removeClass(o.toggleClass).addClass(o.styleClass);

            $(this).mouseout(function(){

                $(this).find("img.referanslar-bant-img").removeClass(o.styleClass).addClass(o.toggleClass);
